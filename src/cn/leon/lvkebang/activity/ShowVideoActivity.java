...
public class ShowVideoActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.leon.lvkebang.R.layout.showvideo_activity);
		loadingLayout = (RelativeLayout) findViewById(cn.leon.lvkebang.R.id.loading_layout);
		progressBar = (ProgressBar) findViewById(cn.leon.lvkebang.R.id.progressBar);
