...
public class RecorderVideoActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.leon.lvkebang.R.layout.recorder_activity);
	...
	private void initViews() {
		btn_switch = (Button) findViewById(cn.leon.lvkebang.R.id.switch_btn);
		btn_switch.setOnClickListener(this);
		btn_switch.setVisibility(View.VISIBLE);
		mVideoView = (VideoView) findViewById(cn.leon.lvkebang.R.id.mVideoView);
		btnStart = (ImageView) findViewById(cn.leon.lvkebang.R.id.recorder_start);
		btnStop = (ImageView) findViewById(cn.leon.lvkebang.R.id.recorder_stop);
		btnStart.setOnClickListener(this);
		btnStop.setOnClickListener(this);
		mSurfaceHolder = mVideoView.getHolder();
		mSurfaceHolder.addCallback(this);
		mSurfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
		chronometer = (Chronometer) findViewById(cn.leon.lvkebang.R.id.chronometer);
	}
...
//		}
	...
	public void onClick(View view) {
		switch (view.getId()) {
		case cn.leon.lvkebang.R.id.switch_btn:
			switchCamera();
			break;
		case cn.leon.lvkebang.R.id.recorder_start:
			// start recording
		    if(!startRecording())
		        return;
			Toast.makeText(this, cn.leon.lvkebang.R.string.The_video_to_start, Toast.LENGTH_SHORT).show();
			...
			chronometer.start();
			break;
		case cn.leon.lvkebang.R.id.recorder_stop:
			...
			new AlertDialog.Builder(this)
					.setMessage(cn.leon.lvkebang.R.string.Whether_to_send)
					.setPositiveButton(cn.leon.lvkebang.R.string.ok,
					...
					.setNegativeButton(cn.leon.lvkebang.R.string.cancel,
							new DialogInterface.OnClickListener() {
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			String st3 = getResources().getString(cn.leon.lvkebang.R.string.Whether_to_send);
			new AlertDialog.Builder(this)
					.setMessage(st3)
					.setPositiveButton(cn.leon.lvkebang.R.string.ok,
							new DialogInterface.OnClickListener() {
							...
							}).setNegativeButton(cn.leon.lvkebang.R.string.cancel, null)
					.setCancelable(false).show();
		}
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this)
				.setTitle(cn.leon.lvkebang.R.string.prompt)
				.setMessage(cn.leon.lvkebang.R.string.Open_the_equipment_failure)
				.setPositiveButton(cn.leon.lvkebang.R.string.ok,
						new DialogInterface.OnClickListener() {
