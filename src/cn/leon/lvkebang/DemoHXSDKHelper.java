...
import cn.leon.lvkebang.applib.model.HXNotifier;
import cn.leon.lvkebang.applib.model.HXSDKModel;
...
import cn.leon.lvkebang.activity.MainActivity;
import cn.leon.lvkebang.activity.VideoCallActivity;
import cn.leon.lvkebang.activity.VoiceCallActivity;
import cn.leon.lvkebang.domain.RobotUser;
import cn.leon.lvkebang.domain.User;
import cn.leon.lvkebang.receiver.CallReceiver;
...
public class DemoHXSDKHelper extends HXSDKHelper {
    ...
    protected void initEventListener() {
        eventListener = new EMEventListener() {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                case EventNewCMDMessage:
                {
                    ...
                    final String CMD_TOAST_BROADCAST = "leon.demo.cmd.toast";
        ...
        EMChatManager.getInstance().addChatRoomChangeListener(new EMChatRoomChangeListener(){
            private final static String ROOM_CHANGE_BROADCAST = "leon.demo.chatroom.changeevent.toast";
