...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(cn.leon.lvkebang.R.drawable.chatfrom_voice_playing);
		} else {
			voiceIconView.setImageResource(cn.leon.lvkebang.R.drawable.chatto_voice_playing);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
	...
	private void showAnimation() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(cn.leon.lvkebang.R.anim.voice_from_icon);
		} else {
			voiceIconView.setImageResource(cn.leon.lvkebang.R.anim.voice_to_icon);
		}
	...
	public void onClick(View v) {
		String st = activity.getResources().getString(cn.leon.lvkebang.R.string.Is_download_voice_click_later);
		if (isPlaying) {
