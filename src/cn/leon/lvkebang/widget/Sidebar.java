 ...
 */
package cn.leon.lvkebang.widget;
...
public class Sidebar extends View{
	...
	private void init(){
	    String st = context.getString(cn.leon.lvkebang.R.string.search_new);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				header = (TextView) ((View)getParent()).findViewById(cn.leon.lvkebang.R.id.floating_header);
			}
			setHeaderTextAndscroll(event);
			header.setVisibility(View.VISIBLE);
			setBackgroundResource(cn.leon.lvkebang.R.drawable.sidebar_background_pressed);
			return true;
		}
